...
module.exports = () => {
  describe('User Messages', () => {
    describe('POST Message Tests - /api/users/:id/messages', () => {
    ...
    describe('GET Message Tests - /api/users/:id/messages/:message_id', () => {
    ...
    describe('DELETE Message Tests - /api/users/:id/messages/:message_id', () => {
